...
function jsFlowTracker (client, announceUrl, opts) {
  console.log('innuti jsFlowTracker funktionen')
	var self=this
 ...
 // TO DO: Ta emot PeerId och skapa ny Peer

 	 }



 // TO DO: send-mettod who sends infoHash and peerId to tracker/peer
  		// TO DO: send message via jsFlow
